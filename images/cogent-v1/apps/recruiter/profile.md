...
## Input
You receive the candidate handle via your spawn channel. Read their record from `data/candidates/{handle}.json`.
...
4. Write the report to `data/candidates/{handle}.html`.
