...
const triggers: Trigger[] = [
  { id: uuid(), name: "code-reviewer:github.push", trigger_type: null, event_pattern: "github.push", cron_expression: null, program_name: "code-reviewer", priority: 10, enabled: true, created_at: ago(30 * D), fired_1m: 0, fired_5m: 1, fired_1h: 3, fired_24h: 12 },
  { id: uuid(), name: "code-reviewer:github.pr.*", trigger_type: null, event_pattern: "github.pr.*", cron_expression: null, program_name: "code-reviewer", priority: 10, enabled: true, created_at: ago(30 * D), fired_1m: 1, fired_5m: 2, fired_1h: 5, fired_24h: 18 },
  { id: uuid(), name: "test-agent:github.pr.*", trigger_type: null, event_pattern: "github.pr.*", cron_expression: null, program_name: "test-agent", priority: 5, enabled: true, created_at: ago(20 * D), fired_1m: 1, fired_5m: 2, fired_1h: 5, fired_24h: 18 },
  { id: uuid(), name: "test-agent:test.*", trigger_type: null, event_pattern: "test.*", cron_expression: null, program_name: "test-agent", priority: 5, enabled: true, created_at: ago(20 * D), fired_1m: 0, fired_5m: 0, fired_1h: 1, fired_24h: 4 },
  { id: uuid(), name: "deploy-manager:deploy.*", trigger_type: null, event_pattern: "deploy.*", cron_expression: null, program_name: "deploy-manager", priority: 8, enabled: true, created_at: ago(15 * D), fired_1m: 0, fired_5m: 0, fired_1h: 0, fired_24h: 2 },
  { id: uuid(), name: "alert-responder:alert.triggered", trigger_type: null, event_pattern: "alert.triggered", cron_expression: null, program_name: "alert-responder", priority: 15, enabled: true, created_at: ago(25 * D), fired_1m: 0, fired_5m: 1, fired_1h: 2, fired_24h: 7 },
  { id: uuid(), name: "do-content:task.content.*", trigger_type: null, event_pattern: "task.content.*", cron_expression: null, program_name: "do-content", priority: 3, enabled: true, created_at: ago(10 * D), fired_1m: 0, fired_5m: 0, fired_1h: 1, fired_24h: 8 },
  { id: uuid(), name: "daily-digest:cron.daily", trigger_type: null, event_pattern: null, cron_expression: "0 9 * * *", program_name: "daily-digest", priority: 1, enabled: false, created_at: ago(30 * D), fired_1m: 0, fired_5m: 0, fired_1h: 0, fired_24h: 1 },
];
